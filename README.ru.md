...
1. Откройте [agenova.ru](https://agenova.ru).
2. В кабинете подключите сервисы.
3. Сформулируйте задачу в чате.

Отправка: по команде в чате агент умеет отправить. Отдельного экрана подтверждения нет.

Слово MCP в Title/H1 витрины не ставим — здесь, для поиска из IDE.
